/* QRCode (c) 2009 Kazuhiko Arase, MIT; bundled locally, no CDN. */
(function(root){const modules={"./QR8bitByte":function(module,exports,require){
...
}};const cache={};function require(name){if(!cache[name]){const m={exports:{}};cache[name]=m;modules[name](m,m.exports,require);}return cache[name].exports;}root.YarusQREncoder=require("./index");})(globalThis);
